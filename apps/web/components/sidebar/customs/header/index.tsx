...
import { SidebarHeader as SidebarHeaderComponent } from '@foodify/design-system/components/sidebar';
            ...
            <Popover placement="bottom" showArrow={true}>
                <PopoverTrigger className='cursor-pointer rounded-sm'>
                    <div className='flex items-center gap-2'>
                        ...
                        {open && <p className='text-2xl leading-1.5 font-semibold text-white'>{selectedOrganization?.title?.slice(0, 15)}</p>}
                    </div>
                </PopoverTrigger>
                <PopoverContent className='w-[360px] overflow-hidden pb-0'>
                    <div className="px-1">
                        <p className="text-small font-semibold px-4 py-2">Restaurants</p>
                        <Divider />
                        <ListboxWrapper>
                            <Listbox
                        ...
                        <div className="flex items-center gap-2 overflow-hidden">
                            <Button variant="light" startContent={<Avatar size='sm' fallback={<Plus size={16} strokeWidth={1.5} />} />} className='w-full rounded-none text-md '>Create New Restaurant</Button>
                        </div>
                    </div>
                </PopoverContent>
            </Popover>
