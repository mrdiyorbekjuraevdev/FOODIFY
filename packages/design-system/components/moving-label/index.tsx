        ...
        >
            <div className="absolute inset-0" style={{ borderRadius: `calc(${borderRadius} * 0.96)` }}>
                <MovingBorder duration={duration} rx="30%" ry="30%">
                    <div
                        className={cn(
                            'h-12 w-20 opacity-[0.6] bg-[radial-gradient(#22c55e_15%,transparent_60%)]',
                            borderClassName
                        )}
                    />
                </MovingBorder>
            ...
            <div
                className={cn(
                    'relative bg-green-900/[10] border border-green-800 backdrop-blur-xl text-white flex items-center justify-center w-full h-full text-sm antialiased',
                    className,
                )}
                style={{
